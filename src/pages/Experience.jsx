...
const Experience = ()=>{
    return(
        <div className="mx-12 mt-20" id="experience">
            ...
            <Company img={gopillz} companyName="AICA HEALTH (aka Gopillz Ai) - Full Stack Web Development Intern" content='Designed and implemented machine learning models for a healthcare platform, ensuring scalability and efficiency using AWS and Elasticsearch. Developed both frontend and backend componenets, including API creation and integration, using React, Tailwind CSS and FastAPI ' duration='March 2024 - Present' />

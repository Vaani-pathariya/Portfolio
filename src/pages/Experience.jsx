...
const Experience = ()=>{
    return(
        <div className="mx-12 mt-20" id="experience">
            ...
            <Company img={edc} companyName="Entrepreneurship Development Cell JSSATEN - Technical Memeber" content='As a member of EDC, Ive had the privilege of participating in a wide range of activities that foster entrepreneurship and creativity. One of the core functions of our cell has been organizing workshops, seminars, and guest lectures. These events have not only expanded my knowledge but have also exposed me to real-world insights and strategies for launching and scaling businesses.' duration='November 2022 - December 2023' />
